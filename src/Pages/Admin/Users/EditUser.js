...
export default function AddNewUser() {
    ...
    const {editUser} = useSelector(state => state.DrawerMovieReducer);
    ...
    const formik = useFormik({
        ...
        onSubmit: async values=>{
            try {
                ...
                alert('Sửa Người Dùng Không Thành Công')
                console.log(error)
            }
        },
    })
            ...
            <form onSubmit={formik.handleSubmit}>
                <div className='grid grid-cols-2 gap-2'>
                    <div className='col-span-1'>
                        ...
                        <Input name='taiKhoan' disabled value={formik.values.taiKhoan} onChange={formik.handleChange} onBlur={formik.handleBlur} className='mt-1'></Input>
                    ...
                    <div className='col-span-1'>
                        ...
                        <Input name='hoTen' onChange={formik.handleChange} value={formik.values.hoTen} onBlur={formik.handleBlur} className='mt-1'></Input>
                        {formik.errors.hoTen && formik.touched.hoTen ? <p className='text-red-400 mt-1'>{formik.errors.hoTen}</p> : ''}

                    </div>
                    <div className='col-span-2'>
                        <label className='text-lg '>Email</label>
                        <Input  name='email' onChange={formik.handleChange} value={formik.values.email} onBlur={formik.handleBlur} className='mt-1'></Input>
                    ...
                    <div className='col-span-2'>
                        ...
                        <Input name='matKhau' onChange={formik.handleChange}  value={formik.values.matKhau} type='password' onBlur={formik.handleBlur} className='mt-1'></Input>
                    ...
                    <div className='col-span-2'>
                        ...
                        <Input name='soDt' onChange={formik.handleChange} value={formik.values.soDt} onBlur={formik.handleBlur} className='mt-1'></Input>
                    ...
                    <div className='col-span-2'>
                        <Button htmlType='submit' className='w-full mt-3 h-10'>Sửa</Button>
                    </div>
                </div> 
            </form>
        </div>
